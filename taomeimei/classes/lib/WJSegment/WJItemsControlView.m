...
-(void)setTitleArray:(NSArray *)titleArray
{
    ...
    for (int i=0; i<titleArray.count; i++) {
        ...
        if(i==0){
            ...
            _currentIndex = 0;
            self.line = [[UIView alloc] initWithFrame:CGRectMake(_config.itemWidth*(1-_config.linePercent)/2.0,btn.frame.origin.y + 8.5, _config.itemWidth*_config.linePercent, _config.lineHieght)];
